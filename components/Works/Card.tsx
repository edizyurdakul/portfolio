  ...
  return (
    <div className="p-8  dark:bg-zinc-800 rounded-[4px] bg-zinc-100 shadow-sm hover:shadow-lg transition-all ease-in-out hover:translate-y-[-2px]">
      ...
      <div className="flex space-x-2 mt-2">
        {work.github != "" ? (
          <div className="px-2 py-1 dark:text-zinc-50 dark:bg-zinc-900 dark:border-zinc-900 hover:dark:border-zinc-50 transition-all ease-in-out text-zinc-900 hover:border-zinc-900 border border-zinc-200 bg-zinc-200 rounded-[4px] min-w-[120px] w-fit flex justify-center">
            <NextLink href={work.github} passHref>
              <a>GitHub</a>
            </NextLink>
          </div>
        ) : null}
        {work.live != "" ? (
          <div className="px-2 py-1 dark:text-zinc-50 dark:bg-zinc-900 dark:border-zinc-900 hover:dark:border-zinc-50 transition-all ease-in-out text-zinc-900 hover:border-zinc-900 border border-zinc-200 bg-zinc-200 rounded-[4px] min-w-[120px] w-fit flex justify-center">
            <NextLink href={work.live} passHref>
              <a>Live</a>
            </NextLink>
          </div>
        ) : null}
